...
const Whchoose = () => {
    return (
        <div className="flex py-8 mt-12 bg-slate-100 my-14 h-[400px]">
            ...
            viewport={{ once: false, amount: 0.7 }}
            className="flex-1">
                <SectionTitle subHeading={"Our Core Values"}
                ...
                <ul className="ml-8">
                    ...
                    <li className="flex items-center pb-2 gap-2">
                        <div className="text-pink-500"><TbSquareRotatedFilled></TbSquareRotatedFilled></div>
                        <div>Sustainable approach to our environment, society, and business.
                        </div>
                    </li>
